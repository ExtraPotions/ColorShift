...
**Author:** [ExtraPotions](https://github.com/ExtraPotions) · **Next release:** `theme-picker-2.2.0`
...
| Script | Version (in 2.2.0) | Install |
| --- | --- | --- |
| **ManaPool Theme Picker** | 2.2.0 | [download](https://github.com/ExtraPotions/super-octo-parakeet/releases/latest/download/manapool-theme-picker.user.js) |
| **SteamGifts Theme Picker** | 2.2.0 | [download](https://github.com/ExtraPotions/super-octo-parakeet/releases/latest/download/steamgifts-theme-picker.user.js) |
| Theme Picker common (`@require`) | 1.16.0 | [download](https://github.com/ExtraPotions/super-octo-parakeet/releases/latest/download/theme-picker-common.js) |
| Scryfall Theme Picker | 2.2.0 | [download](https://github.com/ExtraPotions/super-octo-parakeet/releases/latest/download/scryfall-theme-picker.user.js) |
