...
Site themes + settings for **Mana Pool**, **Scryfall**, and **SteamGifts** by **ExtraPotions**.
...
**License:** [CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/) — attribution to ExtraPotions required; **non-commercial** (do not profit from this work).
...
[CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/) — Copyright (c) 2025–2026 **ExtraPotions**. Attribution required. **Non-commercial** — do not profit from this work.
