...
Themes and settings for **Mana Pool**, **Scryfall**, and **SteamGifts** by **ExtraPotions**.
...
**License:** [CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/) — attribution to ExtraPotions required; non-commercial.
