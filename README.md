...
**Author:** [ExtraPotions](https://github.com/ExtraPotions) · **Latest:** `theme-picker-2.14.0` · **Next release:** `theme-picker-2.15.0`
...
| Script | Version (in 2.14.0) | Install |
| --- | --- | --- |
| **ManaPool Theme Picker** | 2.14.0 | [download](https://github.com/ExtraPotions/super-octo-parakeet/releases/latest/download/manapool-theme-picker.user.js) |
| **SteamGifts Theme Picker** | 2.14.0 | [download](https://github.com/ExtraPotions/super-octo-parakeet/releases/latest/download/steamgifts-theme-picker.user.js) |
| Theme Picker common (`@require`) | 1.27.0 | [download](https://github.com/ExtraPotions/super-octo-parakeet/releases/latest/download/theme-picker-common.js) |
| Scryfall Theme Picker | 2.14.0 | [download](https://github.com/ExtraPotions/super-octo-parakeet/releases/latest/download/scryfall-theme-picker.user.js) |
...
- **theme-picker-2.14.0** — fix missing settings menu when shared helper `@require` fails; dual CDN require; always mount FAB
