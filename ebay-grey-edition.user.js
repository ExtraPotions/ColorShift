...
// @version        1.5.1
// @description    Dark charcoal theme for eBay — hardened chrome + Grey Edition FAB
// @author         ExtraPotions
...
(function () {
  ...
  function isLight(rgb) {
    if (!rgb) return false;
    return (rgb.r + rgb.g + rgb.b) >= 600 || (rgb.r >= 245 && rgb.g >= 245 && rgb.b >= 245);
  }
