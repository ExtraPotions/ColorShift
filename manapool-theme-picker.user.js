  ...
  if (!GE || typeof GE.mountSettingsFab !== 'function' || !GE.version) {
    ...
    try {
      var showTip = function () {
        if (!document.body || document.getElementById('theme-picker-helper-missing')) return;
    ...
    try { GE.applyDocumentFlags('manapool'); } catch (eFlags) {}
    try { GE.registerMenus('manapool', 'https://raw.githubusercontent.com/ExtraPotions/super-octo-parakeet/main/assets/manapool-favicon.svg'); } catch (eReg) {}
    try { GE.mountSettingsFab('manapool', 'https://raw.githubusercontent.com/ExtraPotions/super-octo-parakeet/main/assets/manapool-favicon.svg'); } catch (eFab) {}
  }
