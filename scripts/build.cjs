...
for(const [site,name]of sites){
  const metadata=[['name','ColorShift for '+name],['namespace',repo],['version',version],['description','Theme palettes, accessible settings and site enhancements.'],['author','ExtraPotions'],['license','CC-BY-NC-4.0'],['icon',`${raw}/assets/${site}-colorshift-128.png`],['match',`*://${site}.com/*`],['match',`*://www.${site}.com/*`],['run-at','document-start'],['downloadURL',`${repo}/releases/latest/download/${site}-theme-picker.user.js`],['updateURL',`${repo}/releases/latest/download/${site}-theme-picker.user.js`],['require',`${raw}/theme-picker-common.js`],['grant','GM_getValue'],['grant','GM_setValue'],['grant','GM_registerMenuCommand']];
