...
const sites=[['manapool','ManaPool','svg','image/svg+xml'],['scryfall','Scryfall','ico','image/x-icon'],['steamgifts','SteamGifts','ico','image/x-icon'],['tcgplayer','TCGPlayer','ico','image/x-icon']];
const icons={};
for(const [site,,extension,type]of sites){
...
for(const [site,name,extension]of sites){
