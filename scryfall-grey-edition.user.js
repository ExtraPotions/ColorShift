...
// @version        1.5.0
// @description    Dark charcoal theme for Scryfall — readable blues, themed chips, non-home pages
// @author         ExtraPotions
// @match          *://scryfall.com/*
...
(function () {
  ...
  function darkenLightSurfaces() {
    ...
    for (var j = 0; j < list.length; j++) {
      ...
      if (el.closest && el.closest('.card-image, picture, svg, img, .card-grid-item-card, .card-face')) continue;
