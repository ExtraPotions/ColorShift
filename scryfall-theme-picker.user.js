...
(function () {
  ...
  if (!GE || typeof GE.mountSettingsFab !== 'function' || !GE.version) {
    ...
    try { GE.applyDocumentFlags('scryfall'); } catch (eFlags) {}
    try { GE.registerMenus('scryfall', 'https://raw.githubusercontent.com/ExtraPotions/super-octo-parakeet/main/assets/scryfall-favicon.ico'); } catch (eReg) {}
    try { GE.mountSettingsFab('scryfall', 'https://raw.githubusercontent.com/ExtraPotions/super-octo-parakeet/main/assets/scryfall-favicon.ico'); } catch (eFab) {}
  }
