...
// @version        1.5.0
// @description    Dark charcoal Grey Edition theme for SteamGifts (and SteamTrades / SGTools). Compatible with ESGST (JustArchi/A-ESGST). Derived from SG Dark Grey by SquishedPotatoe (CC-BY-SA-4.0).
// @author         ExtraPotions
...
function addCss() {
  var css = `/* SteamGifts Grey Edition v1.5.0  2026-07-26 */
:root {
