...
`;
  ...
  try {
    var _GE = (typeof globalThis !== 'undefined' && globalThis.GreyEdition) || (typeof window !== 'undefined' && window.GreyEdition);
  ...
  node.setAttribute('name', 'Theme SteamGifts Grey Edition');
  node.setAttribute('id', 'SteamGifts Grey Edition');
