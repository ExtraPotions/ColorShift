...
// @version        2.3.0
// @icon           https://raw.githubusercontent.com/ExtraPotions/super-octo-parakeet/main/steamgifts-eye-icon.svg
...
:root {
  ...
  --SGSP-visited-other-txt-color: rgba(98, 159, 192, 0.85);
...
.sidebar__shortcut-inner-wrap > *:not(.sidebar__search-container):not(:active), .tab-links a, .profile_links .btn_action.white:not(:active), .esgst-sgpb-button:not(:active) {
    background-image: linear-gradient(hsl(0, 0%, 22%) 0%, hsl(0, 0%, 14%) 100%)!important;
...
.esgst-ap-popout {
    background-color: var(--SGSP-body-bg-color)!important;
    border-radius: 4px!important;
    box-shadow: 0 0 0 1px var(--SGSP-content-border-color)!important;
...
.esgst-ags-panel.esgst-popout {
    background-color: var(--SGSP-body-bg-color)!important;
    background-image: linear-gradient(var(--SGSP-sidebar-bg-color) 0%, var(--SGSP-sidebar-bg-color) 100%)!important;
    margin-top: -1px!important;
}
...
.esgst-gv-popout .esgst-giveaway-links [data-draggable-id="egh"]:hover, .esgst-gv-popout .esgst-giveaway-links [data-draggable-id="search"]:hover, .esgst-gv-popout [data-draggable-id="ut"]:hover, .esgst-gv-popout .esgst-giveaway-links [data-draggable-id="gt"]:hover, .esgst-gv-popout .esgst-giveaway-links [data-draggable-id="gf"]:hover, .esgst-gv-popout .esgst-giveaway-links [data-draggable-id="hideGame"]:hover, .esgst-gv-popout .giveaway__heading .esgst-egh-button:hover, .esgst-gv-popout .giveaway__heading .esgst-gb-button:hover, .esgst-gv-popout .giveaway__heading .esgst-tag-button:hover, .esgst-gv-popout .giveaway__heading .esgst-gf-hide-button:hover, .esgst-gv-popout .giveaway__heading .giveaway__icon:hover, .esgst-gv-popout .esgst-giveaway-links .esgst-gb-button:hover, .esgst-gv-popout .esgst-giveaway-links .esgst-tag-button:hover, .esgst-gv-popout .esgst-giveaway-links .esgst-gf-hide-button:hover, .esgst-gv-popout .esgst-giveaway-links .giveaway__icon:hover {
...
.ui-tooltip-content .tooltip {
    ...
    box-shadow: 0 0 0 1px var(--SGSP-tooltip-border-color);
    color: var(--SGSP-link-txt-color)!important;
    margin: -3px;
    text-shadow: var(--SGSP-ts-71);
}
...
.esgst-mm-headings > * {
    background-image: var(--SGSP-header-footer-bg-color);
    border: none;
    box-shadow: 0 0 0 1px var(--SGSP-content-border-color), 0 0 0 1px var(--SGSP-content-border-color), 1px 1px 0 hsla(0, 0%, 23%, 0.5) inset, 1px 1px 0 hsla(0, 0%, 23%, 0.5) inset;
}
...
.esgst-mm-sections {
    ...
    box-shadow: 0 0 0 1px var(--SGSP-content-border-color), 0 0 0 1px var(--SGSP-content-border-color);
    padding: 8px 8px 5px;
}
...
.esgst-giveaway-links [data-draggable-id] .btn_action, .esgst-giveaway-links [data-draggable-id] .btn_action:hover, .esgst-giveaway-links [data-draggable-id] .btn_action:active, .giveaway__links .esgst-button, .giveaway__links .esgst-button:not([data-draggable-id="elgb"]):hover, .giveaway__links .esgst-button:active {
    background: none!important;
    border: none!important;
    box-shadow: none!important;
    font-size: 13px;
...
.giveaway__heading .esgst-button-container.esgst-elgb-button [data-draggable-id="elgb"] {
    padding :0 6px;
    width: unset;
}
...
.giveaway__quick-entry-form, .giveaway__quick-entry-btn--description, .giveaway__quick-entry-loading, .giveaway__quick-entry-btn--insert.is-locked {
    color: hsl(0, 0%, 62%);
}
.giveaway__quick-entry-btn--insert, .giveaway__quick-entry-form, .giveaway__quick-entry-btn--description, .giveaway__quick-entry-btn--delete {
    background-image: linear-gradient(hsl(0 0% 27%) 0%, hsl(0 0% 21%) 100%);
    border-color:var(--SGSP-giveaway-columns-border-color);
    transition: filter 0.35s ease-in, color 0.35s ease-in;
...
.tooltip_row i, .giveaway__quick-entry-btn--insert, .giveaway__quick-entry-btn--delete  {
    --color-yellow-3: var( --SGSP-yellow-buttons-txt-color);
    --color-green-3: var(--SGSP-green-icons-txt-color);
    --color-blue-3: var(--SGSP-link-txt-color);
}
...
.esgst-gv-popout .giveaway__links .esgst-button-container [data-draggable-id="elgb"] {
    border: 1px solid #000!important;
    border-color: var(--SGSP-green-buttons-border-color)!important;
    display: inline-block!important;
    font-size: 12px;
...
.esgst-gv-popout .giveaway__links .esgst-button-container [data-draggable-id="elgb"], .esgst-gv-popout .giveaway__links .esgst-button-container [data-draggable-id="elgb"] i {
    color: var(--SGSP-enter-green-buttons-txt-color)!important;
}
.esgst-gv-popout .giveaway__links .esgst-button-container [data-draggable-id="elgb"].is-disabled i {
    color: var(--SGSP-silver-buttons-txt-color)!important;
}
.esgst-gv-popout .giveaway__links .esgst-button-container [data-draggable-id="elgb"].sidebar__entry-delete i {
    color: var(--SGSP-enter-yellow-buttons-txt-color)!important;
}
.esgst-gv-popout .giveaway__links .esgst-button-container [data-draggable-id="elgb"].sidebar__error i {
    color: var(--SGSP-enter-red-buttons-txt-color)!important;
}
.esgst-gv-popout .esgst-giveaway-links .esgst-button-container.esgst-elgb-button {
    display: inline-block!important;
}
.esgst-gv-popout .giveaway__heading .esgst-button-container .esgst-elgb-desc-shortcut {
    background-image: linear-gradient(hsl(0 0% 33%) 0%, hsl(0 0% 25%) 100%);
    padding: 1px 6px 0;
}
.esgst-gv-popout .esgst-giveaway-links .esgst-elgb-desc-shortcut {
    background-image: linear-gradient(hsl(0 0% 33%) 0%, hsl(0 0% 25%) 100%);
    padding: 0 6px;
}
.esgst-gv-popout .esgst-panel-flexbox + div .esgst-elgb-desc-shortcut {
    background-image: linear-gradient(hsl(0 0% 33%) 0%, hsl(0 0% 25%) 100%);
}
.esgst-gv-popout .giveaway__heading .esgst-button-container.esgst-elgb-button [data-draggable-id="elgb"] {
    padding: 1px 6px;
    line-height: 15px;
}
.esgst-gv-popout .giveaway__heading [data-draggable-id="elgb"].form__saving-button.is-disabled, .esgst-gv-popout .esgst-giveaway-links [data-draggable-id="elgb"].form__saving-button.is-disabled {
    overflow: clip;
    max-width: 8.5ch;
}
...
`;
  ...
  node.setAttribute('name', 'Theme SteamGifts Theme Picker');
  node.setAttribute('id', 'SteamGifts Theme Picker');
...
(function () {
  try {
    ...
    if (typeof GE.registerMenus === 'function') GE.registerMenus('steamgifts', 'https://raw.githubusercontent.com/ExtraPotions/super-octo-parakeet/main/steamgifts-eye-icon.svg');
    else if (typeof GE.mountSettingsFab === 'function') GE.mountSettingsFab('steamgifts', 'https://raw.githubusercontent.com/ExtraPotions/super-octo-parakeet/main/steamgifts-eye-icon.svg');
    // Always inject feature flags (hide entered/ended etc.) even on Original
    if (typeof GE.rootCss === 'function') {
      var extra = GE.rootCss();
      var s = document.getElementById('theme-picker-steamgifts-flags');
      if (!s) {
        s = document.createElement('style');
        s.id = 'theme-picker-steamgifts-flags';
